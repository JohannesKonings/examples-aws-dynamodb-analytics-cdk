...
import { EventBridgePipeConstruct } from "@common/src/constructs/eventBridgePipe.js";
...
export class DdbKinesisAthenaStack extends Stack {
  constructor(scope: Construct, id: string, props: DdbKinesisAthenaStackProps) {
    ...
    new EventBridgePipeConstruct(this, "PersonEventBridgePipe", {
      table: dynamoDbTable.table,
      deliveryStream: firehoseDeliveryStream.firehoseDeliveryStream,
    });
